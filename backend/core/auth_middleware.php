...
function requireAuth()
{
    ...
    if (!$user) {
        file_put_contents('php://stderr', "[" . date('Y-m-d H:i:s') . "] Auth Failure: No valid token found." . PHP_EOL);
...
function requireRole($allowedRoles)
{
    ...
    if (!hasRole($user['role'], $allowedRoles)) {
        file_put_contents('php://stderr', "[" . date('Y-m-d H:i:s') . "] Auth Failure: User role '{$user['role']}' not in [" . implode(', ', (array)$allowedRoles) . "]" . PHP_EOL);
